...
JPH_CAPI JPH_VehicleEngineSettings* JPH_VehicleEngineSettings_Create(void);
...
JPH_CAPI void JPH_VehicleEngineSettings_SetNormalizedTorque(JPH_VehicleEngineSettings* settings, JPH_LinearCurve* normalizedTorque);
