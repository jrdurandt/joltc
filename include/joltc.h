...
JPH_CAPI void JPH_LinearCurve_Reserve(JPH_LinearCurve* linearCurve, uint numPoints);
...
JPH_CAPI void JPH_VehicleEngineSettings_GetInertia(JPH_VehicleEngineSettings* settings, float inertia);
